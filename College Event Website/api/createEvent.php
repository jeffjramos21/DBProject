<?php
    ...
    {   
        ...
        else if($Event_Type == $RSO)
        {
            ...
            $sql = "INSERT INTO rso_events(Event_Name, Event_Type, Event_Category, Rso_Name, Event_Date,Event_Start_Time, Event_End_Time, Contact_Email, Contact_Phone, Description, Address) VALUES ('" . $Event_Name . "', '" . $Event_Type . "', '" . $Cat . "', '" . $rso . "', '" . $date . "', '" . $start . "','" . $end . "', '" . $email . "', '" . $phone . "', '" . $desc . "', '" . $address . "')";
            //$locations = "INSERT INTO location(Latitude,Longitude) VALUES ('" . $lat . "','" . $lon . "')";
